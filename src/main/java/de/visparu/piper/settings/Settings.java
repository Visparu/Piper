...
public final class Settings
{
	...
	private static final int	DEFAULT_START_DELAY_TICKS	= Difficulty.EASY.getDelayTicks();
	...
	public static int	START_DELAY_TICKS	= Settings.DEFAULT_START_DELAY_TICKS;
	...
	public static final void setDifficulty(Difficulty difficulty)
	{
		Settings.changeSettings(difficulty.getWidth(), difficulty.getHeight(), difficulty.getDelayTicks(),
				difficulty.getProgressIncrement(), difficulty.getFixedPieces(), difficulty.getEntries(),
				difficulty.getExits());
	}
	
	public static final void changeSettings(int board_width, int board_height, int start_delay_ticks,
			float progress_increment, int[] board_fixed_pieces, int board_entries, int board_exits)
	{
		Settings.BOARD_WIDTH = board_width;
		Settings.BOARD_HEIGHT = board_height;
		Settings.START_DELAY_TICKS = start_delay_ticks;
