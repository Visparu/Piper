...
public final class Settings {
    ...
    public static void setDifficulty(Difficulty difficulty) {
        Settings.changeSettings(difficulty.getWidth(), difficulty.getHeight(), difficulty.getDelayTicks(), difficulty.getProgressIncrement(), difficulty.getFixedPieces(), difficulty.getEntries(), difficulty.getExits());
    }
