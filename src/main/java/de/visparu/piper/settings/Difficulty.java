...
public final class Difficulty
{
	...
	private static final int[] FIXED_PIPES_EASY = new int[]
	{
			1, 1, 1, 0, 0
	};
	
	private static final int[] FIXED_PIPES_MEDIUM = new int[]
	{
			1, 1, 1, 1, 1
	};
	
	private static final int[] FIXED_PIPES_HARD = new int[]
	{
			2, 2, 2, 1, 1
	};
	
	private static final int[] FIXED_PIPES_WTF = new int[]
	{
			3, 3, 3, 4, 3
	};
	...
	private int[]	fixedPieces;
	private int		entries;
	private int		exits;
	
	private Difficulty(int width, int height, float delaySeconds, float pipeSeconds, int[] fixedPieces, int entries,
			int exits)
	{
		this.width = width;
		this.height = height;
