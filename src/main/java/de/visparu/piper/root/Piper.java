...
public final class Piper
{
	...
	{
		Board board = new Board(Settings.BOARD_WIDTH, Settings.BOARD_HEIGHT, Settings.START_DELAY_TICKS,
				Settings.PROGRESS_INCREMENT, Settings.BOARD_FIXED_PIECES, Settings.BOARD_ENTRIES, Settings.BOARD_EXITS,
				rand);
